...
import { RotateCcw, Inbox, AlertTriangle, CheckCircle2 } from "lucide-react";
...
export default function RefundIssuesPage() {
  const [tickets] = useState<SupportTicket[]>(() => TICKETS_DATA.filter((t) => t.category === "Refund Delay"));
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Refund Delay Issues" description="Tickets raised for delayed or pending refunds" />

      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        <KpiCard label="Total" value={String(kpis.total)} icon={RotateCcw} />
      ...
      <DataTable
        ...
        data={tickets}
        searchKey="subject"
        searchPlaceholder="Search refund issues..."
        exportName="refund-issues"
        emptyTitle="No refund delay issues found"
