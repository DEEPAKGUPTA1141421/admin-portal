...
export default function SellerTicketsPage() {
  const [tickets] = useState<SupportTicket[]>(() => TICKETS_DATA.filter((t) => t.requesterType === "seller"));
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Seller Tickets" description="Support tickets raised by sellers" />
      ...
      <DataTable
        ...
        data={tickets}
        searchKey="subject"
        searchPlaceholder="Search seller tickets..."
        exportName="seller-tickets"
